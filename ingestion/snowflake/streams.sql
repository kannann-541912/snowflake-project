...
-- ============================================================
-- Landing table streams — captures raw files loaded by COPY INTO
-- ============================================================

-- Raw customers landing table (created by COPY INTO from stage)
DEFINE TABLE SANDBOX.TPCH_LANDING.CUSTOMERS_RAW (
    CUSTOMER_ID     NUMBER,
    NAME            VARCHAR(100),
    EMAIL           VARCHAR(255),
    CREATED_AT      VARCHAR(30),        -- loaded as string, cast in transform
